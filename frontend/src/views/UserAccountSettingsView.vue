<template>
  <div class="min-vh-100 d-flex flex-column" style="background-color: #f8f9fa;">
    <div class="container py-5 flex-grow-1">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="card border shadow-sm">
            <div class="card-body p-5">
              <h2 class="fw-bold mb-2" style="color: #1D2A5B;">Account Settings</h2>
              ...
              <div class="mb-4 text-center">
                <div class="position-relative d-inline-block">
                  <img 
                    ...
                    alt="Profile Picture"
                    style="object-fit: cover; border-color: #1D2A5B !important;"
                  />
                  <div v-else class="rounded-circle d-flex align-items-center justify-content-center mb-2 border border-3" style="width:120px;height:120px;background-color: #1D2A5B; border-color: #1D2A5B !important;">
                    <span class="text-white fw-bold" style="font-size: 48px;">{{ userInitials }}</span>
                  </div>
                </div>

                <div class="d-flex justify-content-center gap-2 mt-2">
                  <label class="btn mb-0" style="border: 1px solid #1D2A5B; color: #1D2A5B;">
              ...
              <div class="mb-5">
                ...
                <form @submit.prevent="updateProfile">
                  ...
                  <div class="text-end mt-3">
                    <button type="submit" class="btn" style="background-color: #1D2A5B; color: white; border: none;" :disabled="loadingProfile">
              ...
              <div class="mb-5">
                ...
                <form @submit.prevent="updatePassword">
                  ...
                  <div class="text-end mt-3">
                    <button type="submit" class="btn" style="border: 1px solid #1D2A5B; color: #1D2A5B; background-color: white;" :disabled="loadingPassword">
              ...
              <div v-if="limitsEnabled" class="mb-5">
                ...
                <form @submit.prevent="submitLimit">
                  ...
                  <div class="text-end mt-3">
                    <button type="submit" class="btn" style="background-color: #1D2A5B; color: white; border: none;" :disabled="loadingLimit">
